...
function AboutAlertit() {
	return (
		<>
			<section className="relative py-20 p-8 2xl:py-24 pt-0 bg-gray-800 overflow-hidden">
				<Image
					className="animate-spin-slow"
					src={starsIcon}
					alt="Silver stars"
				/>
				<h1 className="text-6xl text-white text-center pb-12">Features</h1>
				<div className="relative container px-4 mx-auto">
					<div className="flex flex-wrap -mx-10">
						<div className="relative w-full lg:w-1/2 px-6 mb-10 lg:mb-20">
							<div
								id="alertit-intro"
								className="px-6 py-12 md:pt-16 md:pb-0 md:px-16 lg:min-h-[480px] bg-gray-600 rounded-lg"
							>
								...
								<h3 className="my-8 text-4xl font-bold text-white">
									Monitoring pings
								</h3>
						...
						<div className="relative w-full lg:w-1/2 px-6 mb-10 lg:mb-20">
							<div className="px-6 py-12 md:py-16 md:px-16 lg:min-h-[480px] bg-gray-600 rounded-lg">
