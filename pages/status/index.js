  ...
  return (
    <div className = "h-screen flex justify-center">
      <form onSubmit = {handleSubmit} className = "flex h-10 space-x-2 mt-20">
          <input
            class="placeholder:italic placeholder:text-slate-500 text-base block bg-white border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Monitor ID" type="text" name="searchInput"
            required
          />
